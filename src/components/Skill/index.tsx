...
export function Skill({ directionLeft, tech: { name, src } }: Props) {
  return (
      <motion.div
        ...
        className="relative group rounded-full border border-brand-gray h-24 w-24 inline-block"
      >
        <Image
          ...
          width={500}
          height={500}
          className="absolute inset-1/2 -translate-x-1/2 -translate-y-1/2 object-contain h-16 w-16"
        />
